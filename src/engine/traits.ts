...
export const TRAITS: Record<TraitKey, TraitDef> = {
  berserker: {
    key: 'berserker', label: 'Adrenal Overclock',
    desc: 'Combat-stim implant hits harder in melee but leaves the wearer open — deadlier and more fragile.',
    substat: { strength: 2, technique: 1, toughness: -2, armourUse: -1 },
    injuryMult: 1.15, trainingMult: 1,
  },
  stalwart: {
    key: 'stalwart', label: 'Servo-Braced',
    desc: 'A powered exo-frame — soaks punishment at the cost of quickness.',
    substat: { toughness: 2, armourUse: 2, acceleration: -2 },
    injuryMult: 1, trainingMult: 1,
  },
  deadeye: {
    key: 'deadeye', label: 'Targeting Optics',
    desc: 'Smartlink implants grant uncanny aim with ranged weapons.',
    substat: { eyesight: 2, steadiness: 2, handling: 1 },
    injuryMult: 1, trainingMult: 1,
  },
  fleet: {
    key: 'fleet', label: 'Servo Legs',
    desc: 'Augmented legs — lightning-quick across the deck.',
    substat: { acceleration: 2, manoeuvre: 2 },
    injuryMult: 1, trainingMult: 1,
  },
  composed: {
    key: 'composed', label: 'Neural Governor',
    desc: 'A cortical regulator keeps them ice-cold under pressure — sharper judgement in the thick of it.',
    substat: { awareness: 2, discipline: 2 },
    injuryMult: 1, trainingMult: 1,
  },
  fragile: {
    key: 'fragile', label: 'Faulty Wiring',
    desc: 'Unstable implants — gets hurt easily, a worrying injury record.',
    substat: {},
    injuryMult: 1.5, trainingMult: 1,
  },
  ironhide: {
    key: 'ironhide', label: 'Subdermal Plating',
    desc: 'Woven armour beneath the skin shrugs off wounds that would sideline others.',
    substat: {},
    injuryMult: 0.55, trainingMult: 1,
  },
  prodigy: {
    key: 'prodigy', label: 'Neural Lace',
    desc: 'A learning lace — improves faster in training than their peers.',
    substat: {},
